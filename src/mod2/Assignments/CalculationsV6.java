...
public class CalculationsV6 {
    public static void main(String[] args) {
        ...
        // 2.04 Assignment
        System.out.println( dNum1 + "(" + dNum1 + " / " + dNum2 + ") = " + (dNum1 * (dNum1/dNum2)) );
        System.out.println( dNum1 + " * " + dNum1 + " = " + (dNum1 * dNum1));
        System.out.println( dNum2 + " / " + dNum1 + " / " + dNum2 + " = " + (dNum1 / dNum1 / dNum2));
    }
}
